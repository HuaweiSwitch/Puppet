	...
	module CE
	  ...
	  class Device
		...
		def self.interface_api()
		  if nil == @@interface_api
			@@interface_api = InterfaceApi.new()
		  end
		  @@interface_api
		end
		...
		def self.l3_interface_api()
		  if nil == @@l3_interface_api
			@@l3_interface_api = L3InterfaceApi.new()
		  end
		  @@l3_interface_api
		end
		...
		def self.vlan_batch_api()
		  if nil == @@vlan_batch_api
			@@vlan_batch_api = VlanBatchApi.new()
		  end
		  @@vlan_batch_api		
		end
